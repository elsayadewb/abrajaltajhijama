      ...
      $data = $this->validate(request(),
            [
               ...
               // start virgin tow artcles
                ...
                'section_two_part_one_photo'                         =>v_image(),
                ...
                'section_two_part_two_photo'                         =>v_image(),
                ...
                'section_two_part_three_photo'                       =>v_image(),
               ...
               // start virgin two articles
                'section_footer_payment_methods_title_ar'          =>trans('admin.section_footer_payment_methods_title_ar'),
                'section_footer_payment_methods_title_en'          =>trans('admin.section_footer_payment_methods_title_en'),
                'section_footer_payment_methods_content_ar'        =>trans('admin.section_footer_payment_methods_content_ar'),
                'section_footer_payment_methods_content_en'        =>trans('admin.section_footer_payment_methods_content_en'),
                'section_footer_contact_us_title_ar'               =>trans('admin.section_footer_contact_us_title_ar'),
                'section_footer_contact_us_title_en'               =>trans('admin.section_footer_contact_us_title_en'),
                'section_footer_contact_us_content_ar'             =>trans('admin.section_footer_contact_us_content_ar'),
                'section_footer_contact_us_content_en'             =>trans('admin.section_footer_contact_us_content_en'),
                'section_footer_part_two_title_ar'                 =>trans('admin.section_footer_part_two_title_ar'),
                'section_footer_part_two_title_en'                 =>trans('admin.section_footer_part_two_title_en'),
                'section_footer_part_two_content_ar'               =>trans('admin.section_footer_part_two_content_ar'),
                'section_footer_part_two_content_en'               =>trans('admin.section_footer_part_two_content_en'),
                'section_footer_part_three_title_ar'               =>trans('admin.section_footer_part_three_title_ar'),
                'section_footer_part_three_title_en'               =>trans('admin.section_footer_part_three_title_en'),
                'section_footer_part_three_content_ar'             =>trans('admin.section_footer_part_three_content_ar'),
                'section_footer_part_three_content_en'             =>trans('admin.section_footer_part_three_content_en'),
                'section_two_part_one_icon'                        =>trans('admin.section_two_part_one_icon'),
                'section_two_part_one_photo'                       =>trans('admin.section_two_part_one_photo'),
                'section_two_part_one_title_ar'                    =>trans('admin.section_two_part_one_title_ar'),
                'section_two_part_one_title_en'                    =>trans('admin.section_two_part_one_title_en'),
                'section_two_part_one_content_ar'                  =>trans('admin.section_two_part_one_content_ar'),
                'section_two_part_one_content_en'                  =>trans('admin.section_two_part_one_content_en'),
                'section_two_part_two_icon'                        =>trans('admin.section_two_part_two_icon'),
                'section_two_part_two_photo'                       =>trans('admin.section_two_part_two_photo'),
                'section_two_part_two_title_ar'                    =>trans('admin.section_two_part_two_title_ar'),
                'section_two_part_two_title_en'                    =>trans('admin.section_two_part_two_title_en'),
                'section_two_part_two_content_ar'                  =>trans('admin.section_two_part_two_content_ar'),
                'section_two_part_two_content_en'                  =>trans('admin.section_two_part_two_content_en'),
                'section_two_part_three_icon'                      =>trans('admin.section_two_part_three_icon'),
                'section_two_part_three_photo'                     =>trans('admin.section_two_part_three_photo'),
                'section_two_part_three_title_ar'                  =>trans('admin.section_two_part_three_title_ar'),
                'section_two_part_three_title_en'                  =>trans('admin.section_two_part_three_title_en'),
                'section_two_part_three_content_ar'                =>trans('admin.section_two_part_three_content_ar'),
                'section_two_part_three_content_en'                =>trans('admin.section_two_part_three_content_en'),
                'gmail'                =>trans('admin.gmail'),
        ...
        // -----------------------------------------End   request section_footer_img_about 
            // ----------------start virgin two articles --------
  // -----------------------------------------start request section_two_part_one_photo 
            if(request()->hasFile('section_two_part_one_photo')){
            $data['section_two_part_one_photo']  = Up()->Upload([
            'file'        =>'section_two_part_one_photo',
            'path'        =>'frontends',
            'upload_type' =>'single',
            'delete_file' =>frontend()->section_two_part_one_photo,
            ]);
            } //section_two_part_one_photo
        // -----------------------------------------End   request section_footer_img_abo
       // -----------------------------------------start request section_two_part_two_photo 
            if(request()->hasFile('section_two_part_two_photo')){
            $data['section_two_part_two_photo']  = Up()->Upload([
            'file'        =>'section_two_part_two_photo',
            'path'        =>'frontends',
            'upload_type' =>'single',
            'delete_file' =>frontend()->section_two_part_two_photo,
            ]);
            } //section_two_part_two_photo
        // -----------------------------------------End   request section_two_part_two_photo
            
       // -----------------------------------------start request section_two_part_three_photo 
            if(request()->hasFile('section_two_part_three_photo')){
            $data['section_two_part_three_photo']  = Up()->Upload([
            'file'        =>'section_two_part_three_photo',
            'path'        =>'frontends',
            'upload_type' =>'single',
            'delete_file' =>frontend()->section_two_part_three_photo,
            ]);
            } //section_two_part_three_photo
        // -----------------------------------------End   request section_two_part_three_photo
            

            // ----------------End   virgin two articles --------
