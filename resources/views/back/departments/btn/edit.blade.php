            ...
            <div class="modal-header">
             ...
             <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    {!! Form::text('dep_name_ar',$dep_name_ar,['class'=>'form-control']) !!}
                </div><!-- /.form-group name -->
                    <div class="form-group">
                    {!! Form::label('name',trans('admin.dep_name_en')) !!}
                    {!! Form::text('dep_name_en',$dep_name_en,['class'=>'form-control']) !!}
                </div><!-- /.form-group name -->
                 <div class="form-group">
                    {!! Form::label('name',trans('admin.description_ar')) !!}
                    {!! Form::textarea('description_ar',$description_ar,['class'=>'form-control']) !!}
                </div><!-- /.form-group name -->
                       <div class="form-group">
                    {!! Form::label('name',trans('admin.description_en')) !!}
                    {!! Form::textarea('description_en',$description_en,['class'=>'form-control']) !!}
                </div><!-- /.form-group description_en -->
                          <div class="form-group">
                    {!! Form::label('name',trans('admin.link')) !!}
