        ...
        <div class="content-wrapper content_wrapper_datatable">
            ...
            <section class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
<div class="card-header card_all_btn_dpe d-none">
    ...
    <a href="departments?id=18" class="btn btn-secondary"> <i class="fas pe-fw fa-cube"></i> {{ trans('admin.dpe_8') }}</a>
                        ...
                        <!-- /.card-header -->
<aside class="@if(setting()->d_type_d_pep == 'd-block') {{'d-none'}} @endif @if(setting()->d_type_d_pep == 'show_tow') {{'d-block'}} @endif">
                ...
                <div class="content_departments card_dark  ">
                    ...
                    <div id="jstree" class="@if(setting()->d_type_d_pep == 'd-none') {{'d-none'}}@else{{'d-block'}} @endif"></div>
