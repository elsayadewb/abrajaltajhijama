{{--<a href="{{ aurl('offers/'.$id.'/edit') }}" class="btn btn-info"><i class="fa fa-edit"></i></a>--}}


 <!-- Trigger the modal with a button -->
<button type="button" class="btn btn-info" data-toggle="modal" data-target="#edit_offers{{ $id }}"><i class="fa fa-edit"></i></button>
<!-- Modal -->
<div id="edit_offers{{ $id }}" class="modal fade" role="dialog">
  ...
  <!-- /.----------------------------------------------------------------- -->
                             <div class="box-body">
                                     {!! Form::open(['route'=>['offers.update',$id],'method'=>'put','class'=>'form_save_in_modal','files'=>true]) !!}
                                    <div class="row">
                                   <div class="col-md-12 content_form_ar" >
                                    ...
                                    <div class="input-group ">
                                        <div class="custom-file">
                                            {!! Form::label('photo',trans('admin.photo_offers'),['class'=>'custom-file-label']) !!}
                                     ...
                                     @if(!empty($photo))
                                       ...
                                       @else
                                      <div class="text-center"> <img   src="{{url('default')}}/offers.png" class="img_100px"></div>
                                       @endif
                                   <!----------------End photo-->
                                   </section> 
                               </div><!-- col-md-12-->
                             ...
                             <!--        {{ Form::button('<i class="fa fa-location-arrow "> '
                                ...
                                <!-- /.----------------------------------------------------------------- -->
                <!-- /.---------- -->
             		  <a href="{{ aurl('offers/'.$id.'/edit') }}" class="btn btn-success "><i class="fa fa-edit"></i> {{trans('admin.edit_page')}}</a>
                       <span>
                         {!! Form::open(['route'=>['offers.destroy',$id],'method'=>'delete' ,'class'=>'d-inline-block']) !!}
