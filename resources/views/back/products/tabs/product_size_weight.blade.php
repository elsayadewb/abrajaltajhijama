...
<aside class="content_tab_info  tab_product_size_weight">
    ...
    <div id="" class="color_data  ">
{{--        <center><h4> {{ trans('admin.color_data') }}</h4> <br><br><br></center>--}}
        <div class="form-group col-md-12">
            <label form="color_id"  >{{trans('admin.color_id')}}</label>
            <div class="" >
                {!! Form::select('color',App\Model\Color::pluck('name_'.lang(),'id'),$products->color,['class'=>' select2 form-control','placeholder'=>trans('admin.color_id')])!!}
            </div>
        </div><!--form-group-->
    </div>
