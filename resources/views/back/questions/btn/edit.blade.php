...
<button type="button" class="btn btn-info" data-toggle="modal" data-target="#edit_questions{{ $id }}"><i class="fa fa-edit"></i></button>
<!-- Modal -->
<div id="edit_questions{{ $id }}" class="modal fade" role="dialog">
                                   ...
                                   <div class="col-md-12 content_form_ar" >
                                    ...
                                    <div class="input-group ">
                                     ...
                                     @if(!empty($photo))
                                       ...
                                       @else
                                      <div class="text-center"> <img   src="{{url('default')}}/questions.png" class="img_100px"></div>
                                       @endif
                                   <!----------------End photo-->
                                   </section> 
                               </div><!-- col-md-12-->
